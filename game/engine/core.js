// The game's visual language: palette, clay materials, the world kit (islands, people, trolleys, tracks, furniture),
// the frog, particles, ghosts, the stage (renderer, lights, camera) and the overlay UI (fades, labels, rewind, glitch).
// (Grown out of the films' engine; the film-only parts are in archive/films/engine/core.js.)
...
// ---------------------------------------------------------------- brand easter egg
// The frog: once per vignette, a small cameo (see GAME.md, and game/core/frog.js for its moves). Faces +z; ~1.2 units long.
